...
const requiredPatterns = [
  ...
  ['client/src/lib/app-version.ts', 'export const APP_VERSION: string = __APP_VERSION__'],
  ['client/src/lib/evidence-package-export.ts', 'appVersion: APP_VERSION'],
  ['client/src/lib/evidence-package-export.ts', 'kyutxo-evidence-package-v${APP_VERSION}-${date}.zip'],
  ['client/src/lib/evidence-package-export.ts', 'Generated by KYUTXO v${escapeHtml(manifest.appVersion)}'],
  ['client/src/components/EvidencePackageBuilder.tsx', 'evidencePackageFilename(generatedAt)'],
  ['client/src/components/EvidencePackageBuilder.tsx', 'evidencePackageFilename(result.manifest.generatedAt)'],
  ['client/src/pages/settings/info-cards-section.tsx', 'import { APP_VERSION } from "@/lib/app-version"'],
