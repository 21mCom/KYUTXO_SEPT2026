...
import {
  ...
  SUPPORTING_EVIDENCE_APPENDIX_HEADING,
  GLOSSARY_APPENDIX_HEADING,
  AML_APPENDIX_HEADING,
...
describe("ProofOfFundsDeclaration — mixed-format proof-of-control PDF", () => {
  ...
  it("pins the exact appendix-heading and disclaimer wording", () => {
    ...
    expect(SUPPORTING_EVIDENCE_APPENDIX_HEADING).toBe(
      "APPENDIX: SUPPORTING EVIDENCE",
    );
    expect(GLOSSARY_APPENDIX_HEADING).toBe("APPENDIX: GLOSSARY OF TERMS");
    expect(AML_APPENDIX_HEADING).toBe("APPENDIX: AML / RISK SCREENING");
    expect(PROVENANCE_APPENDIX_HEADING).toBe(
